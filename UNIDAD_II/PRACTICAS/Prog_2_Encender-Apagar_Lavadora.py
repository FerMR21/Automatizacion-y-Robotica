...
while True:
    ...
    if command:
        # Si el comando contiene "enciende la lavadora", envía "encender" a Arduino
        if "enciende la lavadora" in command.lower():
            ser.write("encender\n".encode())
        # Si el comando contiene "apaga la lavadora", envía "apagar" a Arduino
        elif "apaga la lavadora" in command.lower():
            ser.write("apagar\n".encode())
        else:
